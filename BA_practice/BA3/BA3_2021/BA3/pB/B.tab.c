...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_MulDigit = 13,                  /* MulDigit  */
  YYSYMBOL_List = 14,                      /* List  */
  YYSYMBOL_ListItem = 15                   /* ListItem  */
};
...
{
       0,   103,   103,   106,   109,   114,   117,   120,   123,   128,
     131,   136,   141,   144
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "DIG", "LBR", "RBR",
  "COM", "MUL", "ADD", "$accept", "S", "Sum", "Term", "MulDigit", "List",
  "ListItem", YY_NULLPTR
};
...
{
      -2,   -14,     2,     6,   -14,    -1,     3,     4,     7,     9,
     -14,    -2,     0,    12,     2,   -14,   -14,   -14,     5,    10,
     -14,    12,    13,    10
};
...
{
      19,     1,     2,    17,     2,     8,    10,    11,    23,    18,
      12,    13,    21,    14,    15,     1,    17,    22,     0,    16,
       0,     0,     0,     0,     0,    20
};

static const yytype_int8 yycheck[] =
{
      13,     3,     4,     3,     4,     3,     0,     8,    21,    12,
       7,     7,     7,     6,     5,     3,     3,     7,    -1,    11,
      -1,    -1,    -1,    -1,    -1,    14
};
...
{
       0,     3,     4,    10,    11,    12,    13,    14,     3,    15,
       0,     8,     7,     7,     6,     5,    11,     3,    14,    13,
      15,     7,     7,    13
};
...
#line 1193 "B.tab.c"
  ...
  case 7: /* Term: MulDigit MUL List MUL MulDigit  */
#line 120 "B.y"
                                     {
        printf("Term3\n"); 
    }
...
#line 1209 "B.tab.c"
  ...
  case 9: /* MulDigit: MulDigit MUL DIG  */
#line 128 "B.y"
                        {
        printf("MulDigit1\n");
    }
...
#line 1233 "B.tab.c"
  ...
  case 12: /* ListItem: DIG COM ListItem  */
#line 141 "B.y"
                       {
        printf("ListItem1\n");
    }
